...
export class BrowserConnection {
  ...
  static async executeInPage(pageId: string, code: string, port: number = 9222): Promise<any> {
    ...
    throw new Error('Direct execution requires WebSocket connection. Use "playwright open" with Playwright mode.');
  }
}
