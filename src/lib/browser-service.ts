...
export interface IBrowserService {
   ...
   */
  withBrowser<T>(port: number, action: (browser: Browser) => Promise<T>): Promise<T>;
   ...
   */
  launchChrome(port?: number, browserPathOrType?: string, url?: string): Promise<void>;
...
export class MockBrowserService implements IBrowserService {
  ...
  async withBrowser<T>(port: number, action: (browser: Browser) => Promise<T>): Promise<T> {
  ...
  async withActivePage<T>(port: number, action: (page: Page) => Promise<T>): Promise<T> {
